...
def main():
    ...
    # File paths for A level
    a1_file = os.path.join(processed_data_dir, 'german_words_A1.json')
    a2_file = os.path.join(processed_data_dir, 'german_words_A2.json')
    a1_backup = os.path.join(backups_dir, 'german_words_A1_backup.json')
    a2_backup = os.path.join(backups_dir, 'german_words_A2_backup.json')

    # Backup original files
    shutil.copy(a1_file, a1_backup)
    shutil.copy(a2_file, a2_backup)
    print("\n  Backups created:")
    print("    - backups/german_words_A1_backup.json")
    print("    - backups/german_words_A2_backup.json")
    ...
    with open(a2_file, 'w', encoding='utf-8') as f:
        json.dump({
            'words': new_a2_words,
    ...
    b2_file = os.path.join(processed_data_dir, 'german_words_B2.json')
    c1_file = os.path.join(processed_data_dir, 'german_words_C1.json')
    c2_file = os.path.join(processed_data_dir, 'german_words_C2.json')
    ...
    b1_file = os.path.join(processed_data_dir, 'german_words_B1.json')
    b1_backup = os.path.join(backups_dir, 'german_words_B1_backup.json')
    b2_file = os.path.join(processed_data_dir, 'german_words_B2.json')

    # First, backup the original B1
    shutil.copy(b1_file, b1_backup)
    print("\n  Backup created: backups/german_words_B1_backup.json")
    ...
    print("  - processed_data/by_level/german_words_A1.json")
    print("  - processed_data/by_level/german_words_A2.json")
    print("  - processed_data/by_level/german_words_B1.json")
    print("  - processed_data/by_level/german_words_B2.json")
    print("  - processed_data/by_level/german_words_C1.json")
    print("  - processed_data/by_level/german_words_C2.json")
    print("\nBackup files saved:")
    print("  - backups/german_words_A1_backup.json")
    print("  - backups/german_words_A2_backup.json")
    print("  - backups/german_words_B1_backup.json")
